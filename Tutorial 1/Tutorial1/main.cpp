    ...
    while(window.isOpen())
    {
        ...
        while(window.pollEvent(event))
        {
            ...
            case sf::Event::Resized :
                std::cout << "Window was resized. Width = "
            ...
            case sf::Event::MouseMoved :
                std::cout << "Mouse cursor coordinates x = " << event.mouseMove.x
            ...
            case sf::Event::MouseButtonPressed :
                ...
                {
                    std::cout << "Left button was pressed at x = "
                        << event.mouseButton.x << " y = "
                        << event.mouseButton.y << std::endl;
                }
                else if(event.mouseButton.button == sf::Mouse::Middle)
                {
                    std::cout << "Middle button was pressed at x = "
                        << event.mouseButton.x << " y = "
                        << event.mouseButton.y << std::endl;
                }
                else if(event.mouseButton.button == sf::Mouse::Right)
                {
                    std::cout << "Right button was pressed x = " << event.mouseButton.x
                        << " y = " << event.mouseButton.y << std::endl;
                }

            case sf::Event::MouseWheelMoved :
            {
                std::cout << "Mouse wheel was moved delta = "
                        << event.mouseWheel.delta << std::endl;
            }
